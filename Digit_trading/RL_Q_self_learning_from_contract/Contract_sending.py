...
async def sample_calls(random_number):
        ...
        try :
            ...
            if response and response.get('buy') and response.get('buy').get('contract_id'):
                ...
                if poc and poc.get('proposal_open_contract'):
                    ...
                    return np.array([random_number, profit, net_total]) 
                ...
                await sample_calls(random_number)  # Reconnect on timeout



# asyncio.run(sample_calls(random_number))
